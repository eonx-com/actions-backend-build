...
TAG="${GITHUB_REF}" IMAGE="${DOCKER_IMAGE}" ECR_REPOSITORY="${ECR_REPOSITORY}" /usr/bin/docker-compose -f "${DOCKER_COMPOSE_YML}" build
TAG="${GITHUB_REF}" IMAGE="${DOCKER_IMAGE}" ECR_REPOSITORY="${ECR_REPOSITORY}" /usr/bin/docker-compose -f "${DOCKER_COMPOSE_YML}" push
